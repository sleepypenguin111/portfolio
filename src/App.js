...
function App() {
  return (
    <div className="relative bg-slate-50 pb-10 font-mono bg-green-50	">
      ...
      <div className="z-30 relative">
        <div className="md:flex md:px-24">
          <div className="md:w-4/12 pt-24 lg:pl-24">
            <img class="rounded-t-lg h-64 w-64" src="me.png" alt="" />
          </div>
          <div className="md:w-8/12">
            <p className="lg:pl-32 lg:pr-24 pt-24 pb-12 mt-10 text-6xl font-bold">
      ...
      <div className="relative z-30">
        <h1 className="text-center pt-20 font-bold pb-10 text-4xl">About Me</h1>
        <p className="text-2xl text-center pb-10 md:px-40">
      ...
      <div className="relative z-30">
        <h1 className="text-center font-bold pt-10 pb-20 text-4xl">Projects</h1>
      </div>

      <div className="z-30 relative flex flex-wrap justify-center lg:px-10">
        <div class="flex justify-center px-10 pb-10 hover:scale-105">
          <div class="rounded-lg shadow-lg bg-white max-w-sm">
            ...
            >
              <img class="rounded-t-lg h-64" src="resp.jpg" alt="" />
            </a>
        ...
        <div class="flex justify-center px-10 pb-10 hover:scale-105">
          <div class="rounded-lg shadow-lg bg-white max-w-sm">
            <a
              ...
              data-mdb-ripple-color="light"
            >
              <img class="rounded-t-lg h-64" src="react.jpg" alt="" />
            </a>
        ...
        <div class="flex justify-center px-10 pb-10 hover:scale-105">
          <div class="rounded-lg shadow-lg bg-white max-w-sm">
            <a
              ...
              data-mdb-ripple-color="light"
            >
              <img class="rounded-t-lg h-64" src="air.jpg" alt="" />
            </a>
            <div class="p-6 text-center">
              <h5 class="text-gray-900 text-xl font-medium mb-2">
                Iterative Design
              ...
              <p class="text-gray-700 text-base mb-4">
                Completed a cyclic process of designing by
                ideating,prototyping, critiquing, testing and analyzing an
                interactive website.
              </p>
      ...
      <div className="relative z-30">
        <h1 className="text-center font-bold pt-10 pb-10 text-4xl">Skills</h1>
        <div className="flex justify-center md:mx-36 mb-10 flex-wrap">
          <div className="text-center shadow-lg px-6 py-2 m-2 bg-white rounded-full">
            {/* <img className="h-24" src="img/java.png" alt="Not working" /> */}
            <h2 className="pt-2 pb-2 font-bold">java</h2>
          </div>
          <div className="text-center shadow-lg px-6 py-2 m-2 bg-white rounded-full">
            {/* <img className="h-24" src="img/js.png" alt="Not working" /> */}
            <h2 className="pt-2 pb-2 font-bold">JavaScript</h2>
          </div>
          <div className="text-center shadow-lg px-6 py-2 m-2 bg-white rounded-full">
            {/* <img className="h-24" src="img/typescript.png" alt="Not working" /> */}
            <h2 className="pt-2 pb-2 font-bold">TypeScript</h2>
          </div>
          <div className="text-center shadow-lg px-6 py-2 m-2 bg-white rounded-full">
            {/* <img className="h-24" src="img/c-.png" alt="Not working" /> */}
            <h2 className="pt-2 pb-2 font-bold">C/C++</h2>
          </div>
          <div className="text-center shadow-lg px-6 py-2 m-2 bg-white rounded-full">
            {/* <img className="h-24" src="img/python.png" alt="Not working" /> */}
            <h2 className="pt-2 pb-2 font-bold">Python</h2>
          </div>
          <div className="text-center shadow-lg px-6 py-2 m-2 bg-white rounded-full">
            {/* <img className="h-24" src="img/react.png" alt="Not working" /> */}
            <h2 className="pt-2 pb-2 font-bold">React</h2>
          </div>
          <div className="text-center shadow-lg px-6 py-2 m-2 bg-white rounded-full">
            {/* <img className="h-24" src="img/graphql.png" alt="Not working" /> */}
            <h2 className="pt-2 pb-2 font-bold">GraphQL</h2>
          </div>
          <div className="text-center shadow-lg px-6 py-2 m-2 bg-white rounded-full">
            {/* <img className="h-24" src="img/html-5.png" alt="Not working" /> */}
            <h2 className="pt-2 pb-2 font-bold">HTML</h2>
          </div>
          <div className="text-center shadow-lg px-6 py-2 m-2 bg-white rounded-full">
            {/* <img className="h-24" src="img/css-3.png" alt="Not working" /> */}
            <h2 className="pt-2 pb-2 font-bold">CSS</h2>
          </div>
          <div className="text-center shadow-lg px-6 py-2 m-2 bg-white rounded-full">
            {/* <img className="h-18 w-24 pt-2 pb-2" src="img/Node.png" alt="Not working" /> */}
            <h2 className="pt-2 pb-2 font-bold">Node.js</h2>
          </div>
          <div className="text-center shadow-lg px-6 py-2 m-2 bg-white rounded-full">
            {/* <img className="h-24" src="img/mongoDB.png" alt="Not working" /> */}
            <h2 className="pt-2 pb-2 font-bold">MongoDB</h2>
          </div>
          <div className="text-center shadow-lg px-6 py-2 m-2 bg-white rounded-full">
            {/* <img className="h-24 w-24" src="img/go.png" alt="Not working" /> */}
            <h2 className="pt-2 pb-2 font-bold">Golang</h2>
          </div>
        </div>
      </div>
      <div className="relative z-30">
        <h1 className="text-center font-bold pt-10 pb-10 text-4xl">
          Social Media
        </h1>
      </div>

      <div className="relative z-30 px-36 pb-20 flex justify-center space-x-8">
